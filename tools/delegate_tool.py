...
def _build_top_level_description() -> str:
    ...
    if top_level_mode == "inline":
        execution_rule = (
            "Runs inline on this install: dispatch waits for the consolidated "
            "result in the current turn and never posts a late completion as a "
            "new message. Do not tell the user to keep working while it runs.\n\n"
        )
    else:
        execution_rule = (
