...
def _copilot_runtime_api_mode(
    ...
    # it may be stale from a previous Copilot model switch. When callers are
    # resolving runtime for an explicit switch, derive from that target model
    # rather than the persisted default.
