...
class GatewayConfig:
    ...
    stt_echo_transcripts: bool = False  # Canonical echo flag; false keeps transcript echo opt-in
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GatewayConfig":
        ...
        persist_voice_transcripts = data.get("persist_voice_transcripts")
        if persist_voice_transcripts is None and isinstance(data.get("stt"), dict):
            persist_voice_transcripts = data.get("stt", {}).get("persist_voice_transcripts")
        ...
        if stt_echo_transcripts is None:
            stt_echo_transcripts = echo_voice_transcripts
        if echo_voice_transcripts is None:
            echo_voice_transcripts = stt_echo_transcripts
    ...
    try:
        ...
        if config_yaml_path.exists():
            ...
            if isinstance(stt_cfg, dict):
                gw_data["stt"] = stt_cfg
                if "persist_voice_transcripts" in stt_cfg:
                ...
                if "echo_transcripts" in stt_cfg:
                    gw_data["stt_echo_transcripts"] = stt_cfg["echo_transcripts"]
