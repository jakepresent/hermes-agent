    ...
    for msg in messages:
        ...
        if role in {"user", "assistant"}:
            ...
            if role == "assistant":
                ...
                # "input item ID does not belong to this connection". Preserve
                # the exact message shape and phase for cache/quality parity,
                # but omit only the connection-scoped id on GitHub.
