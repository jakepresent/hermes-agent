...
class APIServerAdapter(BasePlatformAdapter):
    ...
    def _create_agent(
        ...
        # The OpenAI-compatible chat surface also accepts the legacy top-level
        # reasoning fields parsed by ``_reasoning_config_from_chat_body``.
        # Browser-native ``model_options`` wins when both shapes are supplied.
        request_reasoning_config = (
            _request_reasoning_config(model_options) or reasoning_config_override
        )
