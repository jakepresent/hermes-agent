...
DEFAULT_CONFIG = {
    ...
    "display": {
        ...
        # Show each terminal tool's full command block while retaining compact
        # previews for every other tool. Per-platform override via
    ...
    "delegation": {
        "top_level_mode": "background",  # "background" = completion turn later;
                                          # "inline" = wait and return now
        "completion_max_turns": 0,        # 0 = legacy full turn; positive =
                                          # bounded late completion continuation
    ...
    "gateway": {
        ...
        # Last-resort safety net for a live process whose main asyncio loop has
        # stopped advancing. The out-of-loop monitor writes thread-stack
        # forensics and exits with the service-restart code after the threshold.
        "event_loop_watchdog": {
            "enabled": True,
            "heartbeat_seconds": 5,
