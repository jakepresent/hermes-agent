...
class AIAgent:
    ...
    def _github_models_reasoning_extra_body(self) -> dict | None:
        ...
        elif requested_effort == "max" and "max" not in supported_efforts:
    ...
    def _dispatch_delegate_task(self, function_args: dict) -> str:
        ...
        # The operator controls top-level delivery through
        # delegation.top_level_mode (background or inline); the model-facing
        # `background` argument remains ignored. Orchestrator subagents always
        # stay inline so they can compose their workers' summaries.
