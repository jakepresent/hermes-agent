...
def _build_top_level_description() -> str:
    ...
    return (
        ...
        f"{execution_clause}"
        "LIVE ORCHESTRATION: while children run, use action='list' to inspect "
        "live children, action='steer' with subagent_id + message to redirect a "
        "drifting child, or action='stop' to end one early and keep its partial "
        "result.\n\n"
